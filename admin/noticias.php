       ...
       */
        ...
        for ($i = 0; $i < $nfilas; $i++) {
            ...
            print('
                    ...
                    <td><a href="noticias_editar.php?id_noticias=' . $resultado['id_noticias'] . '"class="btn btn-secondary">editar</a></td>
                    <td><a href="noticias_borrar.php?id_noticias=' . $resultado['id_noticias'] . '&imagen=' . $resultado['imagen'] . '" class="btn btn-danger" onclick="return confirm(&quot; Desea eliminar &quot;)">borrar</a></td>
